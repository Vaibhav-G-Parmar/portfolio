...
export const projects: readonly Project[] = [
  {
    ...
    description:
      "Official community app for Yogi Divine Society Canada—events, registration, food service planning, and guest hosting. Scalable Node.js/TypeScript/Express APIs on AWS, JWT/OAuth auth, RBAC, Jest/Mocha/Supertest (~85% coverage), and CI/CD via AWS CodePipeline with CloudWatch monitoring.",
  ...
  },
  {
    ...
    description:
      "Production microservice for text and image fragments—Node.js/Express on AWS with Cognito RBAC, S3/DynamoDB storage optimizations (~40% faster queries), Dockerized UI and API, GitHub Actions CI/CD, ECS orchestration, CloudFormation IaC, and CloudWatch observability.",
